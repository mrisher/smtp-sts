%%%
   ...
   abbrev = "SMTP-TLSRPT"
   category = "std"
   docName = "draft-ietf-uta-smtp-tlsrpt-11"
   ipr = "trust200902"
   area = "Applications"
...
filename for the gzip file of a report to the Policy Domain
"example.net" from the Sending MTA "mail.sender.example.com":
